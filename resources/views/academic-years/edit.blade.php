...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h3 class="text-xl font-semibold text-gray-800 dark:text-white">Edit Tahun Ajaran</h3>
            <p class="text-sm text-gray-500 dark:text-gray-400">Ubah data tahun ajaran</p>
        </div>
    ...
    <form action="{{ route('academic-years.update', $year->id) }}" method="POST"
        ...
        <div>
            ...
            <input type="text" name="year" value="{{ old('year', $year->year) }}"
