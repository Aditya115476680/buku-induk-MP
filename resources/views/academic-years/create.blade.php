...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h3 class="text-xl font-semibold text-gray-800 dark:text-white">Tambah Tahun Ajaran</h3>
            <p class="text-sm text-gray-500 dark:text-gray-400">Contoh: 2025/2026</p>
        </div>
