    ...
    <div x-show="tab==='data_diri'" class="space-y-4">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="date" name="birth_date" value="{{ old('birth_date', isset($student) ? optional($student->birth_date)->format('Y-m-d') : '') }}"
                       class="w-full rounded-lg border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 px-3 py-2 text-gray-800 dark:text-white outline-none focus:ring-2 focus:ring-brandAccent/40">
            </div>
            ...
            <div class="md:col-span-2 flex items-center gap-2">
                <input id="is_active" type="checkbox" name="is_active" value="1"
                       @checked(old('is_active', $student->is_active ?? false))
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="md:col-span-2 flex items-center gap-2">
                <input id="has_scholarship" type="checkbox" name="has_scholarship" value="1"
                       @checked(old('has_scholarship', $student->has_scholarship ?? false))
                       class="rounded border-gray-300">
            ...
            <div>
                ...
                <input type="date" name="exit_date" value="{{ old('exit_date', isset($student) ? optional($student->exit_date)->format('Y-m-d') : '') }}"
                       class="w-full rounded-lg border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 px-3 py-2 text-gray-800 dark:text-white outline-none focus:ring-2 focus:ring-brandAccent/40">
            </div>
            <div>
